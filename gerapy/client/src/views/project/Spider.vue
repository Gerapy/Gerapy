<template>
	<div>
		...
		<!-- 起始链接开始 -->
		<el-form-item>
			<h4 class="inline">{{ $lang.columns.startUrls }}</h4>
		...
		<!-- 类属性开始 -->
		<el-form-item>
			<h4 class="inline">{{ $lang.columns.classAttrs }}</h4>
		...
		<!-- 合法域名 -->
		<el-form-item>
			<h4 class="inline">{{ $lang.columns.allowedDomains }}</h4>
		...
		<!-- 配置项开始 -->
		<el-form-item>
			<h4 class="inline">{{ $lang.columns.customSettings }}</h4>
			<el-button type="primary" class="inline" size="mini"
		...
		<el-form-item>
			<h4 class="inline m-r-sm m-b-md">{{ $lang.columns.innerCode }}</h4>
			<el-input type="textarea" v-model="spider.code.in_class" class="inline" size="small"
								:placeholder="$lang.columns.innerCode"></el-input>
		</el-form-item>

		<el-form-item>
			<h4 class="inline m-r-sm m-b-md">{{ $lang.columns.outerCode }}</h4>
