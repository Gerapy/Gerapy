...
urlpatterns = [
    ...
    url(r'^api/client/(\d+)/project/([^/]+)/spiders', views.spider_list, name='spider_list'),
    url(r'^api/client/(\d+)/project/([^/]+)/spider/([^/]+)/job/([^/]+)/log', views.job_log, name='job_log'),
    url(r'^api/client/(\d+)/project/([^/]+)/spider/([^/]+)$', views.spider_start, name='spider_start'),
    url(r'^api/client/(\d+)/project/([^/]+)/jobs', views.job_list, name='job_list'),
    url(r'^api/client/(\d+)/project/([^/]+)/version', views.project_version, name='project_version'),
    url(r'^api/client/(\d+)/project/([^/]+)/deploy', views.project_deploy, name='project_deploy'),
    url(r'^api/client/(\d+)/project/([^/]+)/job/([^/]+)/cancel', views.job_cancel, name='job_cancel'),
    ...
    url(r'^api/project/([^/]+)/configure', views.project_configure, name='project_configure'),
    url(r'^api/project/([^/]+)/build', views.project_build, name='project_build'),
    url(r'^api/project/([^/]+)/tree', views.project_tree, name='project_tree'),
    url(r'^api/project/([^/]+)/remove', views.project_remove, name='project_remove'),
    url(r'^api/project/([^/]+)/parse', views.project_parse, name='project_parse'),
